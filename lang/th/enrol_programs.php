...
$string['moveafter'] = 'ย้าย "{$a->item}" หลัง "{$a->target}"';
$string['movebefore'] = 'ย้าย "{$a->item}" ก่อน "{$a->target}"';
...
คุณได้ทำโปรแกรม "{$a->program_fullname}” เสร็จสมบูรณ์แล้ว
';
...
โปรแกรม "{$a->program_fullname}" คาดว่าจะเสร็จสมบูรณ์ในวันที่ {$a->program_duedate}
';
...
โปรแกรม "{$a->program_fullname}" คาดว่าจะเสร็จสมบูรณ์ก่อนวันที่ {$a->program_duedate}
';
...
โปรแกรม "{$a->program_fullname}" จะสิ้นสุดในวันที่ {$a->program_enddate}
';
...
$string['source_approval_notification_allocation_subject'] = 'การแจ้งเตือนการอนุมัติโปรแกรม';
$string['source_approval_notification_allocation_body'] = 'สวัสดี {$a->user_fullname},

การสมัครโปรแกรม "{$a->program_fullname}” ของคุณได้รับอนุมัติแล้ว วันที่เริ่มต้นคือ {$a->program_startdate}
';
...
$string['source_manual_result_assigned'] = '{$a} ผู้ใช้งานได้รับการจัดสรรลงในโปรแกรม';
$string['source_manual_result_errors'] = 'ตรวจพบ {$a} ข้อผิดพลาดเมื่อจัดสรรโปรแกรม';
$string['source_manual_result_skipped'] = '{$a} ผู้ใช้งานได้รับการจัดสรรลงในโปรแกรมอยู่แล้ว';
...
$string['source_selfallocation_notification_allocation_subject'] = 'การแจ้งเตือนการจัดสรรโปรแกรม';
$string['source_selfallocation_notification_allocation_body'] = 'สวัสดี {$a->user_fullname},

คุณได้สมัครโปรแกรม "{$a->program_fullname}” วันที่เริ่มต้นคือ {$a->program_startdate}
';
