...
$string['customfieldvisibleto'] = 'Field content visible to';
$string['customfieldvisible:allocated'] = 'Users allocated to programs';
$string['customfieldvisible:allocated_help'] = 'The field should be visible to users allocated to the program';
$string['customfieldvisible:everyone'] = 'Everybody who can see other program details';
$string['customfieldvisible:everyone_help'] = 'The field should be visible to everybody who can see other program details';
$string['customfieldvisible:viewcapability'] = 'Users with view programs capability';
$string['customfieldvisible:viewcapability_help'] = 'The field should be visible to users with the enrol/programs:view capability';
...
$string['searchbyprogramnameorid'] = 'Search by program name or id';
...
$string['sortbyprogramname'] = 'Sort by program name';
$string['sortbyprogramid'] = 'Sort by program id number';
$string['sortbyprogramstart'] = 'Sort by program start date';
$string['sortbyprogramdue'] = 'Sort by program due date';
$string['sortbyprogramend'] = 'Sort by program end date';
...
$string['start'] = 'Start';
$string['strftimedateformatprograms'] = '%d/%m/%y, %I:%M %p';
...
$string['tagarea_enrol_programs_programs'] = 'Programs';
...
$string['timesoon'] = 'Time soon interval for sending notifications';
$string['timesoon_desc'] = 'The time interval used to calculate the time for sending notifications for due soon, end soon notifications';
