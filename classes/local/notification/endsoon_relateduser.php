...
/**
 * Program ends soon notification for related users.
 *
 ...
 */
final class endsoon_relateduser extends base {
    /**
     * Send notifications.
     *
    ...
    public static function notify_users(?stdClass $program, ?stdClass $user): void {
        ...
        $sql = "SELECT pa.*, rur.parent as relateduserid
                  ...
                  JOIN {local_openlms_notifications} n
                       ON n.component = 'enrol_programs' AND n.notificationtype = 'endsoon_relateduser' AND n.instanceid = p.id AND n.enabled = 1
