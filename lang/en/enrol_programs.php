...
$string['customfieldvisible:allocated_help'] = 'The field should  be visible to users enrolled in the programs';
...
$string['customfieldvisible:viewcapability_help'] = 'The field should be visible users with the enrol/programs:view capability';
