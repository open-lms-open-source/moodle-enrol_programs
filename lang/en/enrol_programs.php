...
$string['customfieldvisible:allocated_help'] = 'The field should  be visible to users allocated in the programs';
...
$string['customfieldvisible:viewcapability_help'] = 'The field should be visible to everybody who can see other program details';
