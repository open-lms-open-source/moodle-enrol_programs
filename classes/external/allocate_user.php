...
/**
 * Allocates a user into a program using manual allocation.
 *
 ...
 */
class allocate_user extends external_api {
    ...
    public static function execute(int $userid, int $programid) {
        ...
        $sourceid = $DB->get_field('enrol_programs_sources', 'id', ['programid' => $programid, 'type' => 'manual'], MUST_EXIST);

        manual::allocate_users($programid, $sourceid, [$userid]);
        return true;
    }
