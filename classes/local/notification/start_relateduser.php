 ...
 */
final class start_relateduser extends base {
    /**
     * Send notifications.
     *
    ...
    public static function notify_users(?stdClass $program, ?stdClass $user): void {
        ...
        $sql = "SELECT pa.*, rur.parent as relateduserid
                  ...
                  JOIN {local_openlms_notifications} n
                       ON n.component = 'enrol_programs' AND n.notificationtype = 'start_relateduser' AND n.instanceid = p.id AND n.enabled = 1
        ...
        foreach ($rs as $allocation) {
            ...
            self::notify_related_user($program, $source, $allocation, $user, $relateduser);
        }
        $rs->close();
    }
